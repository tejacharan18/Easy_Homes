...
const Delete = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (showDeleteButton) {
      ...
      axios.delete(`http://localhost:5000/register/delete/${id}`,config).then((res) => {
  ...
  return (
    ...
    <div className='read'>
        ...
        <p>
          ...
          <Link to='/myprofile' className='link'>Cancel Deletion</Link>.
        </p>

        <h3>Contact Support:</h3>
        <p>
          If you have any concerns or encounter issues, please{' '}
          <a href='mailto:support@example.com' className='link'>contact support</a>.
        </p>
